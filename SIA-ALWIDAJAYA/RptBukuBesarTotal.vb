...
Public Class RptBukuBesarTotal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIA_ALWIDAJAYA.RptBukuBesarTotal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBukuBesarTotal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBukuBesarTotal = New RptBukuBesarTotal()
        rpt.Site = Me.Site
        Return rpt
    End Function
