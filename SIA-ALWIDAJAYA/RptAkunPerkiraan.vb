...
Public Class RptAkunPerkiraan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIA_ALWIDAJAYA.RptAkunPerkiraan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptAkunPerkiraan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptAkunPerkiraan = New RptAkunPerkiraan()
        rpt.Site = Me.Site
        Return rpt
    End Function
