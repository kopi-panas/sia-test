...
Public Class RptNeracaSaldoAJP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIA_ALWIDAJAYA.RptNeracaSaldoAJP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptNeracaSaldoAJP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptNeracaSaldoAJP = New RptNeracaSaldoAJP()
        rpt.Site = Me.Site
        Return rpt
    End Function
