...
Public Class RptBukubesarAJP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIA_ALWIDAJAYA.RptBukubesarAJP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBukubesarAJP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBukubesarAJP = New RptBukubesarAJP()
        rpt.Site = Me.Site
        Return rpt
    End Function
