...
Public Class CetakNeracaSaldo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIA_ALWIDAJAYA.CetakNeracaSaldo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCetakNeracaSaldo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CetakNeracaSaldo = New CetakNeracaSaldo()
        rpt.Site = Me.Site
        Return rpt
    End Function
