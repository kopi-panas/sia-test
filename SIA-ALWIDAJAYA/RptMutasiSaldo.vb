...
Public Class RptMutasiSaldo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIA_ALWIDAJAYA.RptMutasiSaldo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMutasiSaldo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMutasiSaldo = New RptMutasiSaldo()
        rpt.Site = Me.Site
        Return rpt
    End Function
