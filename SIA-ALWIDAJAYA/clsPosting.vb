    ...
    Public Sub InsertRugiLaba()
        ...
        Try
            ...
            If dsData.Tables(0).Rows.Count = 0 Then
                ...
                Query = "INSERT INTO tblRugiLaba Values('" & mPeriode & "', '" & "51001" & "' , '" & "Biaya-Biaya" & "', '" & 0 & "', '" & 0 & "')"
                daData = New OleDbDataAdapter(Query, conn)
                dsData = New DataSet
                daData.Fill(dsData)
            Else
