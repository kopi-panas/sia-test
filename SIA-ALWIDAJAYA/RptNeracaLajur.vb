...
Public Class RptNeracaLajur
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIA_ALWIDAJAYA.RptNeracaLajur.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptNeracaLajur
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptNeracaLajur = New RptNeracaLajur()
        rpt.Site = Me.Site
        Return rpt
    End Function
