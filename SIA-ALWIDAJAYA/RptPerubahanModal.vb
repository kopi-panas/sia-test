...
Public Class RptPerubahanModal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIA_ALWIDAJAYA.RptPerubahanModal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPerubahanModal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPerubahanModal = New RptPerubahanModal()
        rpt.Site = Me.Site
        Return rpt
    End Function
