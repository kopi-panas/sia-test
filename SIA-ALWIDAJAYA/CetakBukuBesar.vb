...
Public Class CetakBukuBesar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIA_ALWIDAJAYA.CetakBukuBesar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCetakBukuBesar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CetakBukuBesar = New CetakBukuBesar()
        rpt.Site = Me.Site
        Return rpt
    End Function
