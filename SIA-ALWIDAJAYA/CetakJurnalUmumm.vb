...
Public Class CetakJurnalUmumm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIA_ALWIDAJAYA.CetakJurnalUmumm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCetakJurnalUmumm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CetakJurnalUmumm = New CetakJurnalUmumm()
        rpt.Site = Me.Site
        Return rpt
    End Function
